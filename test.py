...
myCollection.execute_operation('translation',datetime(2002,6,1), {'fieldName':'cidade', 'oldValue':'Vila Rica', 'newValue' :'Ouro Preto'})
...
# testeQuery = myCollection.find_many({'pais' : 'Brasil'})
