...
class UngroupingSusTest(TestBase):
    ...
    def test_ungrouping_sus(self):       
        ...
        query = self.SusCollection.find_many({'UF':'SP','municipio':'355030 SAO PAULO','cid':'08-14 Neoplasmas malignos','ano':1995})
        ...
        query = self.SusCollection.find_many({'UF':'SP','municipio':'355030 SAO PAULO','cid':'08-14 Neoplasmas malignos','ano':1996})        
        ...
        query = self.SusCollection.count_documents({'UF':'SP','municipio':'355030 SAO PAULO','cid':'049 Mieloma mult e neopl malig de plasmócitos','ano':1995})        
        self.assertEqual(query,0,"Não é possível desagrupar o passado, não deveria trazer nenhum resultado (query desagrupada)")        

        query = self.SusCollection.find_many({'UF':'SP','municipio':'355030 SAO PAULO','cid':'049 Mieloma mult e neopl malig de plasmócitos','ano':1996})        
